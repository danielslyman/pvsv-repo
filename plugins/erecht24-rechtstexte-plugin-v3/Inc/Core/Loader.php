...
class Loader {
     ...
     *
     * @var      array    $shortcodes    The shortcdes registered with WordPress to fire when the plugin loads.
     */
    protected $shortcodes;

	/**
	 * Initialize the collections used to maintain the actions and shortcodes.
	 */
