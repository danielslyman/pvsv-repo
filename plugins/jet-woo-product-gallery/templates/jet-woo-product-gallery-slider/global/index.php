...
if ( $pagination && 'vertical' === $settings['slider_pagination_direction'] ) {
	$swiper_wrapper_classes[]    = 'jet-woo-swiper-vertical';
	$swiper_wrapper_classes[] = 'jet-gallery-swiper-v-pos-' . $settings['slider_pagination_v_position'];
} else {
	$swiper_wrapper_classes[]    = 'jet-woo-swiper-horizontal';
	$swiper_wrapper_classes[] = 'jet-gallery-swiper-h-pos-' . $settings['slider_pagination_h_position'];
}
?>
<div class="<?php echo implode( ' ', $wrapper_classes ); ?>" data-featured-image="<?php echo $with_featured_image; ?>">
	<div class="<?php echo implode( ' ', $swiper_wrapper_classes ); ?>">
		<div class="jet-gallery-swiper-slider">
			<div class="jet-woo-product-gallery-slider swiper-container" <?php echo $this->get_slider_data_settings(); ?> dir="<?php echo is_rtl() ? 'rtl' : 'ltr'; ?>">
