...
class DynamicPostsBase extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function register_query_controls()
    {
        ...
        $this->add_control('force_sticky_posts_at_the_top', ['label' => __('Force Sticky Posts at the top', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes', 'condition' => ['query_type' => ['get_cpt', 'dynamic_mode', 'favorites'], 'remove_sticky_posts' => '', 'ignore_sticky_posts' => '']]);
